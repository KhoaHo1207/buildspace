...
import type { UserStats, UserSyncResponse } from "@/types/api";
...
export default function DashboardPage() {
  ...
  const syncUserMutation = useMutation({
    mutationFn: async (): Promise<UserSyncResponse> => {
  ...
  if (!isUserLoaded || isLoading) {
    return (
      <div className="space-y-6">
        <div className="rounded-xl bg-linear-to-r from-purple-600 to-indigo-600 p-6 text-white">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <Progress value={stats?.todayProgress || 0} className="mt-2 h-1" />
          </CardContent>
        </Card>
      </div>
